...
if 'CAT_6' in cat_all:
    ...
    print('  CAT_6 kaldırıldı (%97+ missing)')

# ─── V2: Çok eksik sütunları kaldır (%80+) ───────────
...
print(f'  Silinen yüksek eksikli sütun: {len(drop_num_cols)}')
print(f'  Tutulan sayısal sütun      : {len(keep_num_cols)}')
...
try:
    ...
    feat_names = kept_num + indicator_features + cat_all
...
print(f'\n✅ V2 train.py tamamlandı. Sonuçları V2/README.md dosyasına yazınız.')
